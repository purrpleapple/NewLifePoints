<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Reports.aspx.cs" Inherits="LifePoints.Admin.Admin_Reports" %>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info" style="max-height: 700px; overflow: auto;">
                                <asp:GridView runat="server" ID="GridUser" Visible="true" AutoGenerateColumns="false" Width="100%"
                                    ...
                                    AllowSorting="true">
                                    <Columns>
                                        <asp:BoundField HeaderText="ID" DataField="UI_ID" />
                                        <asp:BoundField HeaderText="Last Name" DataField="UI_LNAME" />
                                        <asp:BoundField HeaderText="FirstName" DataField="UI_FNAME" />
                                        <asp:BoundField HeaderText="Middle Name" DataField="UI_MNAME" />
